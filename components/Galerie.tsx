...
// Platzhalter, solange keine eigenen Aufnahmen vorliegen. Bewusst nur Motive zu
// Leistungen, die der Betrieb tatsächlich anbietet: Seilklettertechnik gehört
// nicht dazu, daher hier Zaun und Sichtschutz statt Baumpflege.
const fallbackImages = [
  { src: "/assets/leistungen/gartenneugestaltung-mit-beleuchtung.webp", alt: "Neu angelegter Garten mit Wegen, Beeten und Gartenbeleuchtung" },
  { src: "/assets/leistungen/pflasterarbeiten-terrasse.webp", alt: "Pflasterarbeiten auf der Baustelle, Platten werden im Splittbett verlegt" },
  { src: "/assets/leistungen/terrassenbau-grossformatplatten-01.webp", alt: "Terrasse mit großformatigen Platten und angrenzender Bepflanzung" },
  { src: "/assets/leistungen/gartenpflege-heckenschnitt.webp", alt: "Gartenpflege, Hecke wird auf Form geschnitten" },
  { src: "/assets/leistungen/zaun-und-sichtschutz.webp", alt: "Montierter Sichtschutzzaun als Abschluss einer Gartenfläche" }
];
