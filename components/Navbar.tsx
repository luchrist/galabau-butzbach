...
// Kein "Referenzen"-Link: die Sektion rendert erst, wenn lib/referenzen-data.ts
// echte Projektfotos enthält. Ein Anker ins Leere wäre ein toter Link.
const SECTION_LINKS = [
  ...
  return (
    ...
    >
      ...
      <nav className="mx-auto flex max-w-[1400px] items-center justify-between px-6 py-[2px] md:px-10">
        {/* Ohne Schatten verschwinden die dunkelgruenen Anteile der Marke im
            Hero-Video, solange die Leiste noch transparent ist. */}
