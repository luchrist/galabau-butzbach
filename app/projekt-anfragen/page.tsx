        ...
        <div className="mx-auto grid max-w-[1400px] grid-cols-12 gap-x-10 gap-y-10 px-6 md:px-10">
          ...
          <aside className="col-span-12 lg:col-span-4">
            <div className="rounded-4xl border border-ink/10 bg-white p-7">
              ...
              <p className="mt-4 font-mono text-[10px] uppercase tracking-[0.22em] text-ink/45">Büro erreichbar</p>
              <p className="mt-2 text-[13px] leading-relaxed text-ink/60">
                {company.officeHours.map((entry) => `${entry.day}: ${entry.hours}`).join(" · ")}
              </p>
              <p className="mt-2 text-[13px] leading-relaxed text-ink/50">
                Auf der Baustelle gehen wir nicht immer ans Telefon. Schreiben Sie per WhatsApp, wir rufen zurück.
              </p>
              {whatsappHref ? (
                <a
                  href={whatsappHref}
